...
1. [**CucumberBot**](https://github.com/username/CucumberBot) *(май – август 2022)*  
...
2. [**MorseLang**](https://github.com/username/MorseLang) *(февраль 2023)*  
   Псевдоязык программирования на **Python**.  
   Рофл-проект, **работает** ✅  

---

3. [**CucumberMsg (old)**](https://github.com/username/CucumberMsg-old) *(апрель 2023)*  
...
4. [**DoubleN**](https://github.com/username/DoubleN) *(июль – август 2023)*  
...
5. [**invert**](https://github.com/username/invert) *(январь 2024)*  
...
6. [**Racing-game**](https://github.com/username/Racing-game) *(июнь 2024)*  
...
7. [**Todo-App**](https://github.com/username/Todo-App) *(январь 2025)*  
...
8. [**FedyxBot**](https://github.com/username/FedyxBot) *(апрель 2025)*  
...
9. [**ccmbrmsg**](https://github.com/username/ccmbrmsg) *(май 2025)*  
